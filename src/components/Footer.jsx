        ...
        >
          <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-3 md:space-y-0">
            ...
            <div className="text-gray-400 text-xs">
              ...
              <p>Email: <a href="mailto:carterjimmy2017@gmail.com" className="hover:text-[#8CA9B4] transition-colors"></a></p>
              <p>Email: <a href="mailto:benardmusereke@gmail.com" className="hover:text-[#8CA9B4] transition-colors"></a></p>
